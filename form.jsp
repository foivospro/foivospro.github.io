...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt=""
  ...
  <div class="breadcrumbs" data-aos="fade-in">
    <div class="container">
      ...
      <p>Here, by answering this simple questionnaire, we will find you the top 3 computer science fields that fit with
        your personality! </p>
    </div>
  </div><!-- End Breadcrumbs -->
    ...
    <div class="form-group" id="radio-buttons">
      <form>
        <div class="text-center mb-1">
          <p><strong>1. Do you have a strong foundation in mathematics and statistics?</strong></p>
        ...
        <div class="text-center">
          ...
          <div class="text-center">
            ...
            <div class="text-center">
              ...
              <div class="text-center mb-3">
                <p><strong>4. Do you find yourself drawn to the challenges and the mission of securing digital
                    systems?</strong></p>
                <div class='d-inline mx-3'>Bad</div>
              ...
              <div class="text-center">
                ...
                <div class="text-center">
                  ...
                  <div class="text-center mb-3">
                    <p><strong>6. Are you keen on building projects like image recognition, natural language processing,
                        or
                  ...
                  <div class="text-center">
                    ...
                    <div class="text-center">
                      ...
                      <div class="text-center mb-3">
                        <p><strong>8. Are you naturally curious about how websites and web applications work and eager
                            to create
                            your own?</strong></p>
                        <div class='d-inline mx-3'>Bad</div>
                      ...
                      <div class="text-center">
                        ...
                        <div class="text-center mb-3">
                          <p><strong>9. Do you find yourself captivated by the intricacies of network
                        ...
                        <div class="text-center">
                          ...
                          <div class="text-center mb-3">
                            <p><strong>10. Are you intrigued by topics like firewalls, encryption, and securing network
                          ...
                          <div class="text-center">
                            ...
                            <div class="text-center mb-3">
                              <p><strong>11. Do you enjoy the process of building and troubleshooting hardware
                                  systems?</strong></p>
                              <div class='d-inline mx-3'>Bad</div>
                            ...
                            <div class="text-center">
                              ...
                              <div class="text-center">
                                ...
                                <div class="text-center mb-3">
                                  <p><strong>13. Do you have an interest in building functional applications?</strong>
                                  </p>
                                  <div class='d-inline mx-3'>Bad</div>
                                ...
                                <div class="text-center">
                                  ...
                                  <div class="text-center">
                                    ...
                                    <div class="text-center mb-3">
                                      <p><strong>15. Do you find analyzing the efficiency and complexity of algorithms
                                        intriguing?</strong></p>
                                      <div class='d-inline mx-3'>Bad</div>
                                    ...
                                    <div class="text-center">
                                      ...
                                      <div class="text-center mb-3">
                                        <p><strong>16. Do you enjoy understanding formal mathematical proofs and the
                                      ...
                                      <div class="text-center">
                                        ...
                                        <div class="text-center mb-3">
                                          <p><strong>17. Do you find the idea of aligning technology with organizational
                                              goals intriguing?</strong></p>
                                          <div class='d-inline mx-3'>Bad</div>
                                        ...
                                        <div class="text-center">
                                          ...
                                          <div class="text-center mb-3">
                                            <p><strong>18. Do you find interesting topics like database management and
                                                how organizations store, retrieve,
                                          ...
                                          <div class="text-center">
                                            ...
                                            <div class="text-center mb-3">
                                              <p><strong>19. Would you like to combine computer science with a different
                                                  field like biology, geology, chemistry or physics?</strong></p>
                                              <div class='d-inline mx-3'>Bad</div>
                                            ...
                                            <div class="text-center">
                                              <div class="text-center mb-3">
                                                <p><strong>20. Would you be interested in broadening your degree rather than specializing it?</strong></p>
                                                <div class='d-inline mx-3'>Bad</div>
                                                <input type="radio" id="rating20.1" name="rating20" value="1">
                                                <label for="rating1">1</label>
  
                                                <input type="radio" id="rating20.2" name="rating20" value="2">
                                                <label for="rating2">2</label>
  
                                                <input type="radio" id="rating20.3" name="rating20" value="3">
                                                <label for="rating3">3</label>
  
                                                <input type="radio" id="rating20.4" name="rating20" value="4">
                                                <label for="rating4">4</label>
  
                                                <input type="radio" id="rating20.5" name="rating20" value="5">
                                                <label for="rating5">5</label>
                                              ...
                                              <a href="login.html" button type="button"
                                                class="btn btn-form">Submit</button> </a>
                                            </div>
      </form>
